...
Create a subset of only female penguis
```{r}
penguin_f <- penguins %>% 
  filter(sex=="female")
...
```
**reject null that the means are the same
yes, reject, small probability that sample means are drawn from same population


## Unbalaced design ANOVA
